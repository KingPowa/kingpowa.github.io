...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "Repositories",
          description: "A series of my repositories and projects you can explore. I will work on more in the future so stay tuned!",
          section: "Navigation",
          handler: () => {
          ...
          title: "CV",
          description: "My Curriculum Vitae, in json format",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/recsys22.html";
            },},{id: "projects-non-stationary-rl-for-forex-trading",
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/trading.html";
            },},{
        id: 'social-cv',
        title: 'CV',
        section: 'Socials',
